"""
Production Django settings for ScholarSeek.
...
# Security Settings - MUST be configured via environment variables
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'scholarseek'),
...
# Fallback to SQLite for development/testing if PostgreSQL not configured
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@scholarseek.com')
